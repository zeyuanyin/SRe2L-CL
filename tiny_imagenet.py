...
class TinyImageNet(ImageFolder):
    ...
    def __init__(self, root, split="train", download=False, **kwargs):
        print(
            "Important: If you have failed to download the dataset, please remove the downloaded file before try again."
        )
...
if __name__ == "__main__":
    dataset = TinyImageNet("~/imagenet", split="train", download=True, transform=None)
    dataset_test = TinyImageNet("~/imagenet", split="val", download=False, transform=None)
